...
🚀🚀🚀 Feel free to [get started](https://github.com/McGill-NLP/llm2vec-gen?tab=readme-ov-file#-quick-start) with out best-performing model, [`McGill-NLP/LLM2Vec-Gen-Qwen3-8B`](https://huggingface.co/McGill-NLP/LLM2Vec-Gen-Qwen3-8B) on HuggingFace. 🚀🚀🚀
